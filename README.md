...
|  양지혜 | 사용자를 생각하며 서비스를 기획 및 구현할 수 있는 좋은 경험이었습니다. 기획 - 와이어프레임 - 프론트엔드 단계를 거치며 여러 테스트를 해본 결과 사용자 경험 데이터가 쌓이고, 사용자의 편의를 고려하여 기획 및 구상하는 단계가 즐겁게 다가왔습니다. 짧은 기간 동안 많은 작업을 해야 하는 이번 프로젝트에서 팀원들과 매일 진행된 개발 진척도 체크를 통해 프로젝트의 일정을 관리하고, 문제가 발생할 경우 즉시 해결책을 모색했습니다. 이 프로젝트를 통해 얻은 다양한 피드백 경험은 앞으로 다른 서비스를 기획하고 개발할 때 큰 도움이 될 것입니다. 사용자 중심 설계(UCD)의 중요성을 직접 체험하면서, 사용자의 만족을 최우선으로 생각하는 서비스 개발의 필요성을 더욱 깊이 이해하게 되었습니다. |
